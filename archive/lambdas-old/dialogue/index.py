...
def finish_run(run_id: str, total_prompt_tokens: int, total_completion_tokens: int, total_time_ms: int):
    ...
    print(f'Run completed: {run_id} (cost=${total_cost:.4f}, avg_time={total_time_ms / NUM_TURNS:.0f}ms)')
